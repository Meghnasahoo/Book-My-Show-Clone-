...
<body>
    <div class="container">
            ...
            <div class="paper">
                <div class="main-contents">
                    ...
                    <div class="success-description">
                        Thank you for completing the payment! Your seats have been booked !
                    </div>
                    <div class="order-details">
                        <div class="order-number-label">Transaction ID</div>
                        <div class="order-number">123456789</div>
                        <div class="complement">Enjoy your movie!</div>
                    </div>
                </div>
        ...
        <center>
			<a href="feedback" class="submit_btn" onclick="login_first()" >Give Feedback</a>
			</center>
		</form> 
    </div>
</body>
