                  ...
                  <div class="col-sm">
                     <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                           ...
                           <p class="card-text"></p>
                          <a href="https://www.youtube.com/watch?v=smTK_AeAPHs" class="btn" onclick="login_first()" >Trailer</a>
                     ...
                     <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                          <h5 class="card-title">Movie Name: <%=MovieName %></h5>
                           ...
                           <p class="card-text"></p>
                           <a href="https://www.youtube.com/watch?v=kpebJezzK30" class="btn" onclick="login_first()" >Trailer</a>
                           <a href="bookingseat" class="btn" onclick="login_first()" >Book Now</a>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-sm">
                     <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                           ...
                           <p class="card-text"></p>
                           <a href="https://www.youtube.com/watch?v=n9xhJrPXop4,https://youtu.be/OiTiKOy59o4?si=dMGa23kDEXKaaeC9" class="btn" onclick="login_first()" >Trailer</a>
                  ...
                  <div class="col-sm">
                     <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                           ...
                           <p class="card-text"></p>
                           <a href="https://www.youtube.com/watch?v=xvszmNXdM4w" class="btn" onclick="login_first()" >Trailer</a>
                  ...
                  <div class="col-sm">
                     <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                           ...
                           <p class="card-text"></p>
                           <a href="https://www.youtube.com/watch?v=lNzZqCb4ero" class="btn" onclick="login_first()" >Trailer</a>
